...
| ConfirmDialog | `ConfirmDialog.jsx` / `ConfirmDialogPortal.jsx` | React 化确认对话框，通过 `ntm:show-confirm-dialog` 事件触发，`ntm:confirm-dialog-closed` 事件通知关闭，用于所有删除确认 |
